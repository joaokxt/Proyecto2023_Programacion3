...
private:
    ...
    NodoArbol<T> *put(T data, T& valor,NodoArbol<T> *r);
 ...
 */
template <class T>
void ArbolBinario<T>::put(T data,T valor) { root = put(data,valor, root); }

template <class T>
NodoArbol<T> *ArbolBinario<T>::put(T data,T& valor, NodoArbol<T> *r)
{
    if (r == nullptr)
    {
